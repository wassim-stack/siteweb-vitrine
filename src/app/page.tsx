  ...
  return (
    <main className="overflow-x-hidden pt-24 lg:pt-28 antialiased">
      <div className="relative container">
        ...
        <section id="home" className="relative">
          ...
          <div className="flex flex-col text-center space-y-12">
            <div className="flex flex-col items-center space-y-6">
              <p className="capitalize border border-slate-700 py-1 px-3 text-xs rounded-3xl cursorpointer hover:border-sky-500 hover:bg-slate-800 shadow-md transition-all">
                new feature is now available
                <ArrowRightCircle className="inline ml-1 w-4 h-4" />
              </p>
              <Heading title="A CRM Dashboard for enginnering teams" />
        ...
        <section
          id="clients"
          className="max-w-[62rem] mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5"
        >
        ...
        >
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <div className="flex flex-col gap-4 items-center text-center lg:items-start lg:text-start">
              ...
              <p className="lg:max-4-[34rem] leading-normal sm:text-lg sm:leading-8">
